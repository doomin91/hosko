...
class Recruit extends CI_Controller {
    ...
    public function index(){
        ...
        $pagination = $this->customclass->front_pagenavi("/m/recruit?ctg=".$CATEGORY.$queryString, $REC_LIST_COUNT, $limit, 5, $nowpage);
        ...
        $this->load->view("/mobile/recruit/recruit_list", $DATA);
    }
    ...
    public function recruit_view($category, $rec_seq){
        ...
        $this->load->view("/mobile/recruit/recruit_view", $DATA);
    }
    ...
    public function recruit_new($category, $rec_seq){
        ...
        $this->load->view("/mobile/recruit/recruit_new", $DATA);
    }
