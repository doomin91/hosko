...
class Mypage extends CI_Controller {
    ...
    public function memberEdit(){
        ...
        $this->load->view("/mobile/mypage/member-edit", $data);
    }
	...
	public function memberResumeRegist(){
		...
		$this->load->view("/mobile/mypage/member-resume_register", $DATA);
	}
	...
	public function memberResumeManage(){
		...
		$this->load->view("/mobile/mypage/member-resume_manage", $DATA);
	}
	...
	public function submissionDoc(){
		...
		$this->load->view("/mobile/mypage/submission-doc", $DATA);
	}
