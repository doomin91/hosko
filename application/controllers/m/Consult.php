...
class Consult extends CI_Controller {
    ...
    function onlineConsultList(){
		...
		$pagination = $this->customclass->front_pagenavi("/m/consult/onlineConsultList/", $listCount, 10, 5, $nowpage);
        ...
        $this->load->view("/mobile/consult/online-consult-list", $data);
    }
	...
	function onlineConsultWrite(){
        ...
        $this->load->view("/mobile/consult/online-consult-write", $data);
    }
	...
	function onlineConsultView($oc_seq){
        ...
        $this->load->view("/mobile/consult/online-consult-view", $data);
    }
    ...
    public function qnaList(){
		...
		$pagination = $this->customclass->front_pagenavi("/m/consult/qnaList/", $listCount, 10, 5, $nowpage);
        ...
        $this->load->view("/mobile/consult/qna-list", $data);
    }
    ...
    public function qnaWrite(){
        ...
        $this->load->view("/mobile/consult/qna-write", $data);
    }
    ...
    public function qnaView($qna_seq){
        ...
        $this->load->view("/mobile/consult/qna-view", $data);
    }


    public function offline(){
        $this->load->view("/mobile/consult/consult_offline");
    }
    ...
    public function apply(){
        ...
        $this->load->view("/mobile/consult/consult_apply", $DATA);
    }
    ...
    public function apply_view($app_seq){
        ...
        $this->load->view("/mobile/consult/consult_apply_view", $DATA);
    }
    ...
    public function apply_edit($app_seq){
        ...
        $this->load->view("/mobile/consult/consult_apply_edit", $DATA);
	...
	public function visitConsultList($visit_date){
		...
		$this->load->view("/mobile/consult/visit-consult-list", $data);
	}
	...
	public function visitConsultWrite($visit_date){
		...
		$this->load->view("/mobile/consult/visit-consult-write", $data);
	}
	...
	public function visitConsultEdit($vcon_seq){
		...
		$this->load->view("/mobile/consult/visit-consult-edit", $data);
	}
	...
	public function visitConsultPassCheck(){
		...
		$this->load->view("/mobile/consult/visit-consult-passcheck", $data);
	}
	...
	public function presentationList(){
		...
		$pagination = $this->customclass->front_pagenavi("/m/consult/onlineConsult/", $listCount, 10, 5, $nowpage);
		...
		$this->load->view("/mobile/consult/presentation-list", $data);
	}
	...
	public function presentationView($pt_seq){
		...
		$this->load->view("/mobile/consult/presentation-view", $data);
	}
