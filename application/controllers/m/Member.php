...
class Member extends CI_Controller {
    ...
    function member_input_step1(){
        ...
        $this->load->view("/mobile/member/input_step1");
    }

    function member_input_step2(){

        $this->load->view("/mobile/member/input_step2");
    }
	...
	function member_input_step3(){
        ...
        $this->load->view("/mobile/member/input_step3");
    }

	function login(){
		//echo md5("1111");
        $this->load->view("/mobile/member/login");
    }
	...
	public function idFind(){
		$this->load->view("/mobile/member/id_find");
	}
	...
	public function pwFind(){
		$this->load->view("/mobile/member/pw_find");
	}
