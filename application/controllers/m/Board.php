...
class Board extends CI_Controller {
    ...
    function q($seq){
        ...
        $this->load->view("/mobile/board_list", $DATA);
    }
    ...
    function g($seq){
        ...
        if(count($boards_info) > 0){
            ...
            $queryString = "search_field=". $searchField. "&search_string=".$searchString;
            $pagination = $this->customclass->front_pagenavi("/m/Board/g/$seq?seq=$board_seq&" . $queryString, $listCount, $limit, 3, $nowpage);
        ...
        $DATA["GROUP_INFO"] = $group_info;
        $DATA["BOARDS_INFO"] = $boards_info;
        $this->load->view("/mobile/board_gallery_list", $DATA);
    }
    ...
    function v($seq){
        ...
        if(count($boards_info) > 0){
            ...
            $queryString = "search_field=". $searchField. "&search_string=".$searchString;
            $pagination = $this->customclass->front_pagenavi("/m/Board/v/$seq?seq=$board_seq&" . $queryString, $listCount, $limit, 3, $nowpage);
        ...
        $DATA["GROUP_INFO"] = $group_info;
        $DATA["BOARDS_INFO"] = $boards_info;
        $this->load->view("/mobile/board_movie_list", $DATA);
    }
    ...
    function board_view($post_seq){
        ...
        $this->load->view("/mobile/board_view", $DATA);
    }
    ...
    function board_write($group_seq){
        ...
        $DATA["GROUP_INFO"] = $group_info;
        $DATA["BOARDS_INFO"] = $boards_info;
        $this->load->view("/mobile/board_write", $DATA);
    }
    ...
    function board_reply($post_seq){
        ...
        $DATA["BOARDS_INFO"] = $boards_info;
        $DATA["POST_INFO"] = $post_info;
        $this->load->view("/mobile/board_reply", $DATA);
    }
    ...
    function board_modify($post_seq){
        ...
        $DATA["BOARDS_INFO"] = $boards_info;
        $DATA["POST_INFO"] = $post_info;
        $this->load->view("/mobile/board_modify", $DATA);
    }
