                    ...
                    <div class="sub_contents">
                        <div class="sub_category">
                            ...
                            <li><a href="/consult/qnaList">Q&A</a></li>
                                ...
                                <li class="on"><a href="/consult/visitConsult">방문신청 상담</a></li>
                        ...
                        <div class="inner">
                            <div class="subContWrap">
                                ...
                                <div class="VisitTopText">
                                    ...
                                    <p>STEP3 상담 신청완료를 진행하시면, HOSKO에서 확인전화를 통해 예약을 확정해드립니다.</p>
                                ...
                                <div class="subContSec mt30">
                                    ...
                                    <div class="table-responsive mb60"  role="grid" id="basicDataTable_wrapper">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                <td>
                                                    <div class="col-lg-12 date-block"><a href="/consult/visitConsultList/<?php echo $_nDay; ?>"><?php echo $this->customclass->numConvertString($i+1); ?></a></div>
                                                    <?php if ($apply_cnt > 0){ ?>
