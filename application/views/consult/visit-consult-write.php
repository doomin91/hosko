                                ...
                                <div class="subContSec">
                                            ...
                                            <div class="type_table">
                                                <div class="col1">
                                                    <div class="boardViewTop_item">
                                                        <strong>신청자명</strong>
                                                        <div class="type_td">
                                                            <input type="text" class="input_s1" name="user_name">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col1">
                                                    <div class="boardViewTop_item">
                                                        <strong>일시</strong>
                                                        <div class="type_td">
                                                            <input type="text" class="input_s1" name="consult_date" readonly value="<?php echo $visit_date; ?>">
                                                ...
                                                <div class="col1">
                                                    <div class="boardViewTop_item">
                                                        <strong>나이</strong>
                                                        <div class="type_td">
                                                            <input type="text" class="input_s1" name="user_age" style="width:100px !important" maxlength="2">
                                                            세
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col1">
                                                    <div class="boardViewTop_item">
                                                        <strong>연락처</strong>
                                                        <div class="type_td">
                                                            <input type="text" class="input_s1" name="user_tel1" style="width:150px !important" maxlength="3">-
                                                            <input type="text" class="input_s1" name="user_tel2" style="width:150px !important" maxlength="4">-
                                                            <input type="text" class="input_s1" name="user_tel3" style="width:150px !important" maxlength="4">
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php
                                                ...
                                                <div class="col1">
                                                    <div class="boardViewTop_item">
                                                        ...
                                                        <div class="type_td">
                                                            <input type="text" name="user_comp" class="input_s1" value="<?php echo isset($userInfo->USER_NAME) ? $userInfo->USER_NAME : ""; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col1">
                                                ...
                                                <div class="col1">
                                                    <div class="boardViewTop_item">
                                                        <strong>전공부서</strong>
                                                        <div class="type_td">
                                                            <input type="text" name="user_major" class="input_s1" value="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col1">
                                                    <div class="boardViewTop_item">
                                                        <strong>비밀번호</strong>
                                                        <div class="type_td">
                                                            <input type="password" name="user_pass" class="input_s1" value="" style="width:200px !important">
                                                             (정보 수정/삭제시 필요합니다.)
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="boardBtnArea pb50">
                                        <div class="btn_box f_right">
                                            <button type="button" class="btn_style02 f_left" id="consultSave">문의하기</button>
