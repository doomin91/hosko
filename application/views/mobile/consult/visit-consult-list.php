...
<script type="text/javascript">
    $(function(){
        ...
        $(document).on("click", "#visit_write", function(){
            ...
            document.location.href="/m/consult/visitConsultWrite/"+date;
        });
        ...
        $(document).on("click", ".vcon_edit", function(){
            seq = $(this).data("seq");
            document.location.href="/m/consult/visitConsultPassCheck/?vcon_seq="+seq+"&mode=edit";
        });

        $(document).on("click", ".vcon_delete", function(){
            seq = $(this).data("seq");
            document.location.href="/m/consult/visitConsultPassCheck/?vcon_seq="+seq+"&mode=delete";
        });
