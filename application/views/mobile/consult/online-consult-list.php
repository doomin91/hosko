                    ...
                    <div class="sub_contents">
                        <div class="sub_category">
                            <ul>
                                ...
                                <li class="on"><a href="/m/consult/onlineConsultList">온라인 상담</a></li>
                                ...
                                <div class="subContSec">
                                    ...
                                    ?>
                                        <div class="tblBot-item">
                                            ...
                                            <span class="col_tit"><a href="/m/consult/onlineConsultView/<?php echo $list->OC_SEQ; ?>"><?php echo $list->OC_SUBJECT; ?></a></span>
...
<script type="text/javascript">
    $(function(){
        $(document).on("click", "#consultWrite", function(){
            document.location.href="/m/consult/onlineConsultWrite"
        })
