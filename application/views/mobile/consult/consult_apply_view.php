                    ...
                    <div class="sub_contents">
                        <div class="sub_category">
                            <ul>
                                ...
                                <li class="on"><a href="/m/consult/apply">포지션&연수 지원</a></li>
                            ...
                            <div class="subContWrap">
                                ...
                                <div class="subContSec mb80">
                                    ...
                                    <div class="ApplyBtnWrap mt30 mb30">
                                        <button type="button" onclick="location.href='/m/consult/apply';" class="applybtn01 f_left">목록보기</button>
                                        <button type="button" onclick="location.href='/m/consult/apply_edit/<?php echo $MY_APPLY->APP_SEQ?>'" class="applybtn02 f_right">수정하기</button>
                                    </div>
