                    ...
                    <div class="sub_contents">
                        <div class="sub_category03">
                            <ul>
                                ...
                                <li class="on"><a href="/m/mypage/memberResumeRegist">이력서 작성</a></li>
...
<script>
    ...
    $(function(){
        ...
        $("#update_resume").on("click", function(){
            ...
            $.ajax({
                url: "/m/mypage/memberResumeUpdateProc",
                type: "POST",
                data: fd,
                dataType: "json",
                contentType: false,
                ...
                success: function(resultMsg){
                    ...
                    if(resultMsg.code == 200){
                        alert(resultMsg.msg);
                        document.location.href="/m/mypage/memberResumeRegist";
                    }else{
                        alert(resultMsg.msg);
        ...
        $("#create_resume").on("click", function(){
            ...
            $.ajax({
                url: "/m/mypage/memberResumeRegistProc",
                type: "POST",
                data: fd,
                dataType: "json",
                contentType: false,
