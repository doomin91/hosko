                ...
                <div class="layout_sub">
                    ...
                    <div class="sub_contents">
                        <div class="sub_category03">
                            <ul>
                                <li class="on"><a href="/m/mypage/memberEdit">정보관리</a></li>
                                <li><a href="/m/mypage/memberResumeRegist">이력서 작성</a></li>
                                <li><a href="/m/mypage/memberResumeManage">제출서류 관리</a></li>
                            </ul>
                        </div>
        ...
        */
        ...
        $.ajax({
			...
			success:function(data){
				...
				if (data.code == "200"){
					alert(data.msg);
					document.location.href="/m/Mypage/memberEdit";
				}else{
                    alert(data.msg);
                }
			}, error:function(e){
