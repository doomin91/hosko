                            ...
                            <div class="subContWrap">
                                ...
                                <form id="post_write_form">
                                    ...
                                    <div class="boardBtnArea pb50">
                                        ...
                                        <div class="btn_box f_right">
                                            <a href="/m/Board/q/<?php echo $GROUP_INFO->GP_SEQ?>?seq=<?php echo $BOARD_INFO->BOARD_SEQ?>"  class="btn_style01">뒤로가기</a>
                                        </div>
...
$("#post_attach").on('change',function(){
  ...
  $(".upload-name").val(fileName);
    ...
    function post_reply(){
		...
		$.ajax({
			url:"/m/board/set_post_info?board_seq=" + board_seq,
			type:"post",
			data:formData,
			dataType:"json",
			processData:false,
