                            ...
                            <div class="subContWrap">
                                ...
                                <div class="subContSec">
                                            ...
                                            <?php 
                                                ...
                                                if($lt->POST_SECRET_YN == "Y"){
                                                    if($lt->POST_USER_SEQ == $this->session->userdata("USER_SEQ") || $this->session->userdata("admin_seq")){
                                                        echo "<a href=\"/m/board/board_view/$lt->POST_SEQ\">$lt->POST_SUBJECT</a>";
                                                    } else {
                                                    ...
                                                    echo "<a href=\"/m/board/board_view/$lt->POST_SEQ\">".$this->customclass->strcut(strip_tags($lt->POST_SUBJECT),100)."</a>";
                                                }
                                    ...
                                    <div class="subBtn_Write f_right mt40">
                                        <a href="/m/Board/board_write/<?php echo $GROUP_INFO->GP_SEQ . "?seq=" . $BOARD_INFO->BOARD_SEQ?>">글쓰기</a>
                                    </div>
                                    <?php endif; ?>
