                                    ...
                                    switch($val->BOARD_TYPE){
                                        case 0:
                                            ...
                                            if($BOARD_INFO->BOARD_SEQ == $val->BOARD_SEQ){
                                                echo "<li class=\"on\"><a href=\"/m/Board/q/$GROUP_INFO->GP_SEQ?seq=$val->BOARD_SEQ\">$val->BOARD_KOR_NAME</a></li>";
                                            }else{
                                                echo "<li><a href=\"/m/Board/q/$GROUP_INFO->GP_SEQ?seq=$val->BOARD_SEQ\">$val->BOARD_KOR_NAME</a></li>";
                                            }
                                            break;
                                        case 1:
                                            // 갤러리 게시판
                                            if($BOARD_INFO->BOARD_SEQ == $val->BOARD_SEQ){
                                                echo "<li class=\"on\"><a href=\"/m/Board/g/$GROUP_INFO->GP_SEQ?seq=$val->BOARD_SEQ\">$val->BOARD_KOR_NAME</a></li>";
                                            }else{
                                                echo "<li><a href=\"/m/Board/g/$GROUP_INFO->GP_SEQ?seq=$val->BOARD_SEQ\">$val->BOARD_KOR_NAME</a></li>";
                                            }
                                            break;
                                        ...
                                        case 2:
                                            // 동영상 게시판
                                            if($BOARD_INFO->BOARD_SEQ == $val->BOARD_SEQ){
                                                echo "<li class=\"on\"><a href=\"/m/Board/v/$GROUP_INFO->GP_SEQ?seq=$val->BOARD_SEQ\">$val->BOARD_KOR_NAME</a></li>";
                                            }else{
                                                echo "<li><a href=\"/m/Board/v/$GROUP_INFO->GP_SEQ?seq=$val->BOARD_SEQ\">$val->BOARD_KOR_NAME</a></li>";
                                            }
                                            break;
                                    }
                                }
                                ...
                                <div class="subContSec">
                                    <div class="boardViewTop">
                                        <div class="type_table">
                                            <div class="col1">
                                                ...
                                                echo "<a href=\"/m/board/board_view/$POST_INFO->POST_SEQ\">".strip_tags($POST_INFO->POST_SUBJECT)."</a>";
                                                            ...
                                                            <li class="file_item">
                                                                <?php
                                                                 foreach($ATTACH as $at){ 
                                                                     ...
                                                                     ?>
                                                                    <a href="/m/Board/downalod_attach/<?php echo $at->ATTACH_SEQ?>" title="파일 다운로드 하기"><em><?php echo $at->ATTACH_FILE_NAME;?></em></a>
                                                                <?php else: ?>
                                    ...
                                    <div class="boardViewBot">
                                        <div class="type_table">
                                            <div class="cont_next">
                                                ...
                                                <div class="type_td">
                                                    <?php 
                                                    echo "<a class=\"ellipsis\" href=\"/m/board/board_view/".$NEXT->POST_SEQ."\">";
                                    ...
                                    <div class="boardViewBot">
                                        <div class="type_table">
                                            <div class="cont_prev">
                                                ...
                                                <div class="type_td">
                                                    <?php 
                                                    echo "<a class=\"ellipsis\" href=\"/m/board/board_view/".$PREV->POST_SEQ."\">";
                                    ...
                                    <div class="boardBtnArea pb50">
                                        <div class="btn_box f_left">
                                            ...
                                            <a href="/m/Board/<?php echo $BOARD_TYPE . "/" . $GROUP_INFO->GP_SEQ?>?seq=<?php echo $BOARD_INFO->BOARD_SEQ?>"  class="btn_style01 ">목록보기</a>
                                        </div>
                                        ...
                                        <div class="btn_box f_right">
                                            <a href="/m/Board/board_modify/<?php echo $POST_INFO->POST_SEQ?>" class="btn_style02 ml5">수정</a>
                                        </div>
                                        <?php endif?>
                                        ...
                                        <div class="btn_box f_right">
                                            <a href="/m/Board/board_reply/<?php echo $POST_INFO->POST_SEQ?>" class="btn_style02">답글</a>
                                        </div>
                                        <?php endif?>
                                        <?php endif?>
            ...
            success:function(data){
                ...
                if(code == 200){
                    ...
                    switch($BOARD_INFO->BOARD_TYPE){
                                        case 0:
                                            // 일반 게시판
                                            echo "location.href=\"/m/Board/q/$GROUP_INFO->GP_SEQ?seq=$BOARD_INFO->BOARD_SEQ\"";
                                            break;
                                        case 1:
                                            // 갤러리 게시판
                                            echo "location.href=\"/m/Board/g/$GROUP_INFO->GP_SEQ?seq=$BOARD_INFO->BOARD_SEQ\"";
                                            break;
                                        
                                        case 2:
                                            // 동영상 게시판
                                            echo "location.href=\"/m/Board/v/$GROUP_INFO->GP_SEQ?seq=$BOARD_INFO->BOARD_SEQ\"";
                                            break;
                                    }
                    ?>
                }
