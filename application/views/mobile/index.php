                    ...
                    <div class="main_visual">
                        ...
                        <div class="right_sidemenu">
                            <ul>
                                ...
                                <li>
                                    <a href="/m/consult/onlineConsultList"><div class="sidemenu_item02"></div></a>
                                </li>                                
                            </ul>
                        </div>
                            ...
                            <div class="inner">
                                <div class="mid_banner01">
                                    ...
                                    <div class="mid_banner_btn">
                                        <a href="/m/company/introduce">Learn More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="mid_board">
                                    <div class="main_news">
                                        <div class="main_news_title">
                                            <h2>호스코 뉴스</h2>
                                            <span><a href="/m/Board/q/1?seq=1"><img src="/static/front/img/main_plus_icon.jpg"></a></span>
                                        </div>
                                    ...
                                    <div class="main_notice">
                                        <div class="main_notice_title">
                                            <h2>질문과 답변</h2>
                                            <span><a href="/m/consult/qnaList"><img src="/static/front/img/main_plus_icon.jpg"></a></span>
                                        </div>
...
function viewPage(post_seq){
    window.location = "/m/board/board_view/" + post_seq;
}
