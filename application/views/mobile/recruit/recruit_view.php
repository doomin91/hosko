                ...
                <div class="layout_sub">
                    ...
                    <div class="sub_contents">
                        <div class="sub_category02">
                            <ul>
                                <li <?php $CATEGORY==1 ? print("class='on'") : "" ?> ><a href="/m/recruit_?ctg=1">인턴쉽</a></li>
                                <li <?php $CATEGORY==2 ? print("class='on'") : "" ?>><a href="/m/recruit?ctg=2">JOB·헤드헌팅</a></li>
                            </ul>
                        </div>
                                ...
                                <div class="subContSec mb50">
                                    ...
                                    <?php if($this->session->userdata("USER_SEQ")) : ?>
                                        <div class="detail_footer">
                                            <button class="recruit_btn01 mr20"><a href="/m/recruit/recruit_new/<?php echo $CATEGORY?>/<?php echo $RECRUIT->REC_SEQ?>">지원하기</a></button>
                                            <button class="recruit_btn02"><a href="/m/recruit?ctg=<?php echo $CATEGORY?>">목록가기</a></button>
                                        </div>
                                    <?php else: ?>
                                        <div class="detail_footer">
                                            <button class="recruit_btn02"><a href="/m/recruit?ctg=<?php echo $CATEGORY?>">목록가기</a></button>
                                    ...
                                    <?php endif ?>
                                        ...
                                        <div class="col-md-12 text-right">
                                            <a href="/m/recruit/recruit_new/<?php echo $CATEGORY?>/<?php echo $RECRUIT->REC_SEQ?>" class="btn btn-s btn-primary">지원하기</a>
                                        </div>
                                        -->
