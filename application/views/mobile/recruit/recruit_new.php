                ...
                <div class="layout_sub">
                    ...
                    <div class="sub_contents">
                        <div class="sub_category02">
                            <ul>
                                <li <?php $CATEGORY==1 ? print("class='on'") : "" ?> ><a href="/m/recruit?ctg=1">인턴쉽</a></li>
                        ...
                        <div class="inner">
                            <div class="subContWrap">
                                ...
                                <div class="detail_footer mb60">
                                    ...
                                    <button class="recruit_btn02"><a href="/m/recruit/recruit_view/<?php echo $CATEGORY?>/<?php echo $RECRUIT->REC_SEQ?>">취소하기</a></button>
                                    
                                    <!--
                                        <input type="button" id="recruit_apply_create" name="recruit_apply_create" class="btn btn-s btn-primary" value="지원하기">
                                        <a href="/m/recruit/recruit_view/<?php echo $CATEGORY?>/<?php echo $RECRUIT->REC_SEQ?>" class="btn btn-s btn-default">취소하기</a>
                                    -->
                                </div>
