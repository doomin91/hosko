					  ...
					  <table class="table datatable table-custom01 userTable">
						...
						?>
								<tr>
									...
									<td><?php echo $lt->OC_REG_DATE; ?></td>
									<td><?php echo $answer_flag; ?></td>
									<td>
									<a href="/admin/consult/onlineConsultView/<?php echo $lt->OC_SEQ; ?>" class="btn btn-default btn-xs clogView">보기</a>
                                        <button class="btn btn-danger btn-xs ocDel" data-seq="<?php echo $lt->OC_SEQ; ?>">삭제</button>
									</td>
								</tr>
						<?php
									$pagenum--;
