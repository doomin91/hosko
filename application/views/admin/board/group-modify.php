						...
						<section class="tile color transparent-black">
							...
							<div class="tile-body">
								...
								<table class="table table-bordered">
										<input type="hidden" name="group_seq" value="<?php echo $group->GP_SEQ?>">
										<tr>
											<th class="info" style="vertical-align:middle">그룹명</th>
											<td><input type="text" name="group_name" class="form-control" value=<?php echo $group->GP_NAME;?>></td>
										</tr>
								</table>
							</div>
							<div class="tile-footer" style="text-align:center;">
								<button type="button" class="btn btn-primary" onclick="groupModify();">수정</button>
	...
	function groupModify(){
		...
		$.ajax({
			url:"/admin/group/group_modify_proc",
			type:"post",
			data:{
				"group_seq" : $("input[name=group_seq]").val(),
