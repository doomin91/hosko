	  ...
	  <!-- Make page fluid -->
		...
		<div id="content" class="col-md-12">
		  ...
		  <div class="main">
                ...
                <form name="abroadRegisterForm" id="abroadRegisterForm" class="form-horizontal" method="post" role="form">
                    <input type="hidden" name="_ctg1" value="<?php echo $ABROAD_INFO->REC_CONTENTS_CATEGORY ?>">
                    <input type="hidden" name="_ctg2" value="<?php echo $ABROAD_INFO->REC_CONTENTS_SUB1_CATEGORY ?>">
                    <input type="hidden" name="_ctg3" value="<?php echo $ABROAD_INFO->REC_CONTENTS_SUB2_CATEGORY ?>">
                    <input type="hidden" name="REC_SEQ" value="<?php echo $ABROAD_INFO->REC_SEQ ?>">
                    <div class="row">
                        <div class="col-md-12">
