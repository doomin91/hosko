                    ...
                    <div class="tile-body">
                        ...
                        <table class="table table-custom dataTable userTable">
                            ...
                            <tbody>
                                <tr>
                                    <th>팝업 제목</th>
                                    <td colspan="3"><input type="text" name="popup_subject" value="" size="150"></td>
                                </tr>
                                <tr>
                                    <th>시작일</th>
                                    <td><input type="text" name="popup_start" class="datepicker" value="" size="20" readonly></td>
                                    <th>종료일</th>
                                    <td><input type="text" name="popup_end" class="datepicker" value="" size="20" readonly></td>
                                </tr>
                                <tr>
                                    <th>팝업크기(가로)</th>
                                    <td><input type="number" name="popup_width" value="100" size="10">px</td>
                                    <th>팝업크기(세로)</th>
                                    <td><input type="number" name="popup_height" value="100" size="10">px</td>
                                </tr>
                                <tr>
                                    <th>위치(top)</th>
                                    <td><input type="number" name="popup_x" value="0" size="10">px</td>
                                    <th>위치(left)</th>
                                    <td><input type="number" name="popup_y" value="0" size="10">px</td>
                                </tr>
                                <tr>
                                    <th>팝업내용</th>
                                    <td colspan="3">
                                        <textarea class="common_input wid100p" name="popup_contents" id="popup_contents"></textarea>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
<script type="text/javascript">
    $(function(){
        ...
        $(document).on("click", "#savePopup", function(){
            ...
            $.ajax({
                url:"/admin/basic/popupWriteProc",
                type:"post",
                data:{
