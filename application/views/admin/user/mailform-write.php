      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            <h2><i class="fa fa-puzzle-piece" style="line-height: 48px;padding-left: 5px;"></i><b>메일폼 관리</b></h2>
                    ...
                    <div class="tile-body">
                       ...
                       <table class="table table-custom dataTable userTable">
                            ...
                            <tbody>
                                <tr>
                                    <th>코드</th>
                                    <td><input type="text" name="mf_code" value="" size="50"></td>
                                </tr>
                                <tr>
                                    <th>메일폼 명칭</th>
                                    <td><input type="text" name="mf_name" value="" size="150"></td>
                                </tr>
                                <tr>
                                    <th>내용</th>
                                    <td>
...
<script type="text/javascript">
    $(function(){
        ...
        $(document).on("click", "#saveMailform", function(){
            ...
            $.ajax({
                url:"/admin/user/mailFormWriteProc",
                type:"post",
                data:{
                    "mf_code" : mf_code,
                    "mf_name" : mf_name,
